...
if 'dados' in st.session_state and not st.session_state.dados.empty:
    ...
    with col_prob:
        ...
        # Sugestão de grupo que não saiu recentemente
    ...
    if meu_palpite:
        ...
        if not ganhou.empty:
            ...
            st.sidebar.success(f"✅ GANHOU! Prêmio: R$ {valor_aposta * fator:.2f}")
        else:
